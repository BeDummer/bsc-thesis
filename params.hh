...
const double C_eps_avg=.3; // weight of Input-Current
const double C_tau_r=.1; // absolute refractory period [tau_m]=10^{-2}[sec]
const int C_N_neuron=5 ; // number of neurons per generation
const int C_N_Gen=1 ; // number of layers in the feedforward-network (generations)
