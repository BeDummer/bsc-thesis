...
const unsigned int C_ndt=4194304;//2097152;//1048576;//524288;//262144;//131072;//65536; // number of timesteps in simulation
const unsigned int C_ndt_mu=C_ndt/8;//32768;//16384; // number of timesteps in bisection
//const double C_eps=.3; // weight of Input-Current
const double C_tau_r=.1; // absolute refractory period [tau_m]=10^{-2}[sec]
const unsigned int C_N_neuron=1000 ; // number of neurons per generation
